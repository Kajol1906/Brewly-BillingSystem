...
import { getRecommendations, Recommendation } from '../../services/aiService';
...
export default function RecommendationEngine() {
  ...
  if (recommendations.length === 0) {
    return (
      <div className="bg-card rounded-2xl p-6 border border-border shadow-soft h-[300px] flex flex-col items-center justify-center">
  ...
  return (
    <motion.div
      ...
      className="relative bg-card rounded-2xl p-6 border border-border shadow-soft overflow-hidden"
    >
      {/* Pulsing Highlight */}
      <motion.div
        animate={{
